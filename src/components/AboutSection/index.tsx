...
const AboutSection = ({ sectionData }: { sectionData: Section_Plain }) => {
    ...
    return (
        <section className='py-8 about-section'>
            ...
            <div className="container mx-auto">
                <div ref={description} className="about-description" dangerouslySetInnerHTML={{__html: sectionData.content}}>
                    {/* <p>
